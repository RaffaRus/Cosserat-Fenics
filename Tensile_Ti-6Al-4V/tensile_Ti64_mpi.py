...
bc = [DirichletBC(V.sub(0), 0, boundary_L), DirichletBC(V.sub(1), 0, boundary_L),  DirichletBC(V.sub(2), 0, boundary_L)]
...
Nitermax, tol = 200, 1e-5  # parameters of the Newton-Raphson procedure
Nincr = 100

# Uncomment to add steps
