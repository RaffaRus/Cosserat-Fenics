# Modified by Tamara Dancheva, Raffaele Russo
#
# .. raw:: html
#
...
Dt = Function(WC, name="Coupled Stress - Wryness Consistent tangent operator")
...
for (i, t) in enumerate(load_steps[0:1]):
    ...
    while nRes > tol and niter < Nitermax:
        ...
        print("Displacement u: ", u1.vector().get_local())
        print("Rotation theta: ", theta1.vector().get_local())
        print("Eto: ", Eps1.vector().get_local())
        print("Kappa: ", Kappa1.vector().get_local())
